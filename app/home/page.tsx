...
export default function Home() {
  return (
    ...
    >
      <h1 className="font-inter text-7xl font-bold text-center mb-4 text-white">
        Bring Your <span className="text-[#C43CCB]">Voice</span> to Life!
      </h1>
      <p className="font-inter text-xl text-center mb-1 text-white">
        Transform your conversation into smart AI solutions in seconds.
      </p>
       {/* Page Break */}
       <div className="page-break"></div>
        <p className="font-inter text-xl text-center mb-6 text-white">
      ...
      <Link
        ...
        >
        <img src="/phone 2.svg" alt="Phone Icon" className="font-inter mr-2 w-6 h-6" />
